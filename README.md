...
For comprehensive E2E testing of the Centralized Authorization architecture (Envoy Gateway, Authorization Service, STS, OpenFGA, and Hook Service with Kafka event streaming):
