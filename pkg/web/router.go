...
func NewRouter(
	...
	router.Mount("/api/v0/groups", gRPCGatewayMux)
	router.Mount("/api/v0/authz_groups", gRPCGatewayMux)
	router.Mount("/api/v0/users", gRPCGatewayMux)
	router.Mount("/api/v0/apps", gRPCGatewayMux)
