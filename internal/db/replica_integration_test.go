...
func TestIntegration_ReplicaLagFallback(t *testing.T) {
	...
	primaryDSN := testhelpers.SetupPostgres(t)

	// Spin up replica container
	replicaDSN := testhelpers.SetupPostgres(t)
...
func (l *integrationLogger) Infof(template string, args ...interface{}) {
	l.t.Logf("INFO: "+template, args...)
}
func (l *integrationLogger) Warnf(template string, args ...interface{}) {
	l.t.Logf("WARN: "+template, args...)
}
func (l *integrationLogger) Errorf(template string, args ...interface{}) {
	l.t.Logf("ERROR: "+template, args...)
}
func (l *integrationLogger) Debugf(template string, args ...interface{}) {
	l.t.Logf("DEBUG: "+template, args...)
}
func (l *integrationLogger) Fatalf(template string, args ...interface{}) {
