...
func TestKafkaIntegration_GroupServicePipeline(t *testing.T) {
	...
	userCtx := groups.ContextWithUserID(ctx, "creator-456")
	...
	adminCtx := groups.ContextWithUserID(ctx, "domain-admin-user")
...
func TestKafkaIntegration_UnavailableDoesNotFailGroupCRUD(t *testing.T) {
	...
	userCtx := groups.ContextWithUserID(ctx, "creator-999")
